...
ARTICLE_CSS = """
  ...
  .ad-slot-photos { display: flex; gap: 8px; margin-bottom: 10px; }
  .ad-slot-photos img { width: 90px; height: 90px; object-fit: cover; border-radius: 10px; box-shadow: var(--shadow); }
  @media (max-width: 480px) { .ad-slot-photos img { width: 66px; height: 66px; } }
...
AD_INLINE = """      <div class="ad-slot">
        <div class="ad-slot-inner">
          <span class="ad-slot-photos">
            <img src="/images/ads/collage-1.jpg" alt="" loading="lazy" width="110" height="110">
            <img src="/images/ads/collage-2.jpg" alt="" loading="lazy" width="110" height="110">
            <img src="/images/ads/collage-3.jpg" alt="" loading="lazy" width="110" height="110">
          </span>
...
def _load_batches():
    ...
    for mod, name in (('articles_batch2', 'ARTICLES2'), ('articles_batch3', 'ARTICLES3'),
                      ...
                      ('articles_batch10', 'ARTICLES10'),
                      ('articles_batch11', 'ARTICLES11'),
                      ('articles_batch12', 'ARTICLES12'),
                      ('articles_batch13', 'ARTICLES13'),
                      ('articles_batch14', 'ARTICLES14'),
                      ('articles_batch15', 'ARTICLES15')):
