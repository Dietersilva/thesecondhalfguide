...
""" + facts('What the data show', [
      ...
      <p>It isn't grab bars. Grab bars address a real hazard, but the strongest evidence sits with
...
""" + check([
      ...
      <p><strong>Is Social Security really tax-free now?</strong> No. What passed is a $6,000 deduction
      for people 65 and older &mdash; a different mechanism. The rules deciding how much of your benefit
      gets taxed were not touched.</p>

      <p><strong>Did a &ldquo;no tax on Social Security&rdquo; law actually pass?</strong> A law passed,
      but not the one the phrase describes. It created a $6,000 deduction for taxpayers 65 and older, for
      tax years 2025 through 2028 &mdash; not an exemption for Social Security income.</p>

      <p><strong>When does it start, and when does it end?</strong> It applies to tax years 2025 through
      2028. It is not permanent, and it expires after the 2028 tax year unless Congress extends it.</p>

      <p><strong>Who qualifies?</strong> Anyone 65 or older by the end of the tax year, with income under
      the phase-out threshold ($75,000 single, $150,000 joint, gone entirely at $175,000 single, $250,000
      joint). Receiving Social Security does not by itself qualify you &mdash; benefits can start at 62,
      well before 65.</p>

      <p><strong>What does it actually mean for my taxes?</strong> It reduces your taxable income by up
      to $6,000, the same as any other deduction. It does not change how much of your Social Security
      benefit counts as income &mdash; that calculation runs exactly as it did before.</p>

      <p><strong>When did Social Security start being taxed in the first place?</strong> The first tier
      dates to 1983 legislation that took effect in 1984 (the $25,000/$32,000 thresholds); a second tier
      was added by 1993 legislation effective 1994 (the $34,000/$44,000 thresholds). Neither has been
      adjusted for inflation since.</p>
""",
    'sources': [
        ('IRS &mdash; Check your eligibility for the new enhanced deduction for seniors',
         'https://www.irs.gov/newsroom/check-your-eligibility-for-the-new-enhanced-deduction-for-seniors'),
...
""" + AD_INLINE + """
      ...
      dollar costs the whole bracket &mdash; about $975 a year in Part B premium alone at the first step in
      2026, plus a separate Part D surcharge on top of that.</p>
